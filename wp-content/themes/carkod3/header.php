...
<div id="header">
<div id="logo">
<h1><img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="Carkod"></h1>
<p><img src="<?php bloginfo('template_url'); ?>/images/description.png" alt="Spotting patterns to reach harmony"></p>
